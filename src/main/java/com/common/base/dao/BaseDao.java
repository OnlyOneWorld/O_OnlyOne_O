...
public interface BaseDao<T> {  
     ...
     */  
//    @SuppressWarnings("hiding")  
//    <T> Pagination findPagination(CharSequence queryString, int pageIndex, int pageSize, Object... params);  
//  
    /**  
     * 分页查询实体  
     *   
     ...
     */  
//    @SuppressWarnings("hiding")  
//    <T> Pagination findPagination(CharSequence queryString, Map<String, Object> params, int pageIndex, int pageSize);  
//  
    /**  
     ...
     */  
//    @SuppressWarnings("hiding")  
//    <T> Pagination findPagination(CharSequence queryString, CharSequence countString, int pageIndex, int pageSize,  
//            Object... params);  
     ...
     */  
//    @SuppressWarnings("hiding")  
//    <T> Pagination findPagination(CharSequence queryString, CharSequence countString, Map<String, Object> params,  
//            int pageIndex, int pageSize);  
     ...
     */  
//    @SuppressWarnings("hiding")  
//    public <T> Pagination findSqlPagination(final CharSequence queryString, final CharSequence countString,  
